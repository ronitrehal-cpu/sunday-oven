...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f3dac6] flex flex-col">
      ...
      {/* Top bar */}
      <header className="relative z-10 px-5 sm:px-10 py-4 flex justify-between items-center">
        <img
          src="/stacked-wordmark.png"
          alt="Sunday Oven"
          className="h-[77px] w-auto object-contain"
        />
        <div className="flex gap-5 sm:gap-8 text-sm">
          <a
          ...
          <a
            href="mailto:hello@sundayoven.com.au"
            className="text-[#3d0a10] hover:opacity-70 transition-opacity flex items-center gap-1.5"
          >
            <Mail size={16} />
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-12 sm:py-16">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-center mb-8 sm:mb-10 opacity-90 leading-relaxed">
            Made in small batches, baked fresh with care just like home.
          </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="px-8 py-3.5 bg-[#f3dac6] text-[#3d0a10] rounded-xl font-semibold sm:font-semibold font-bold hover:bg-[#f3dac6]/90 transition-all duration-200 transform hover:scale-[1.02] text-base whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
