        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <body style="margin: 0; padding: 0; font-family: Arial, Helvetica, sans-serif;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3dac6;" bgcolor="#f3dac6">
                <tr>
                  <td style="background-color: #f3dac6;" bgcolor="#f3dac6">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3dac6;" bgcolor="#f3dac6">
                      <tr>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3dac6;" bgcolor="#f3dac6">
                      <tr>
                        <td style="padding: 20px; background-color: #f3dac6;" bgcolor="#f3dac6">
