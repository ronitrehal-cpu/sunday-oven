...
export const handler: Handler = async (event) => {
  ...
  try {
    ...
    // Normalise email before validation/storage
    ...
    // IMPORTANT: Do not call .select() here because anon has INSERT
    // permission but intentionally does not have SELECT permission.
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin: 20px 0;">
                  ...
                  <p style="margin: 10px 0 0 0;"><strong>Signed up:</strong> ${new Date().toLocaleString(
                    'en-AU',
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" class="container" style="width:560px; max-width:560px; background-color:#3a0f10; border-radius:16px; overflow:hidden; box-shadow:0 20px 48px rgba(58,15,16,0.18);">
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding:28px 40px 0 40px;">
            <a href="https://sundayoven.com.au" target="_blank" style="display:block; text-decoration:none; border:0; outline:none;">
              <img
                src="https://sundayoven.com.au/sundayovenstackednew.png"
                alt="Sunday Oven"
                class="logo-img"
                style="display:block; width:120px; max-width:120px; height:auto; border:0; outline:none; text-decoration:none; margin:0 auto;"
              >
            </a>
          </td>
        </tr>
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding:18px 40px 0 40px;">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      ...
                      <td valign="top" style="padding-top:4px;">
                        <p style="margin:0 0 4px 0; font-family:'Inter',Helvetica,Arial,sans-serif; font-size:15px; font-weight:600; color:#f5ede1;">
                          We bake the first batch
                        </p>

                        <p style="margin:0; font-family:'Inter',Helvetica,Arial,sans-serif; font-size:14px; line-height:1.6; color:#f5ede1; opacity:0.75;">
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      ...
                      <td valign="top" style="padding-top:4px;">
                        ...
                        <p style="margin:0; font-family:'Inter',Helvetica,Arial,sans-serif; font-size:14px; line-height:1.6; color:#f5ede1; opacity:0.75;">
                          Use <strong style="color:#c9a96a; font-weight:600;">FIRSTBATCH10</strong> on your first order to claim your launch perk.
                        </p>
                      </td>
                    </tr>
                  </table>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" style="background-color:#c9a96a; border-radius:50px;">
                  <a
                    href="https://sundayoven.com.au"
                    target="_blank"
                    style="display:inline-block; padding:14px 32px; font-family:'Inter',Helvetica,Arial,sans-serif; font-size:14px; font-weight:600; color:#3a0f10; text-decoration:none; letter-spacing:1px; text-transform:uppercase;"
                  >
                    Visit Sunday Oven
                  </a>
                </td>
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding:16px 40px 20px 40px;">
            <p style="margin:0 0 6px 0; font-family:'Inter',Helvetica,Arial,sans-serif; font-size:12px; line-height:1.6; color:#f5ede1; opacity:0.6;">
              ...
              <a href="https://sundayoven.com.au" style="color:#c9a96a; text-decoration:none;">
                sundayoven.com.au
              </a>.
            </p>
