  ...
  <tr>
    <td align="center" style="padding: 24px 16px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="container" style="width:600px; max-width:600px; background-color:#3a0f10; border-radius:16px; overflow:hidden; box-shadow: 0 24px 60px rgba(58, 15, 16, 0.18);">
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding: 28px 56px 8px 56px;">
            <img src="https://sundayoven.com.au/stackedwordmarkbeige.png"
                 alt="Sunday Oven"
                 class="logo-img"
                 style="display:block; width:160px; max-width:160px; height:auto; border:0; outline:none; text-decoration:none; -ms-interpolation-mode:bicubic;">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding: 20px 56px 24px 56px;">
