      ...
      const userEmailResponse = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          html: `
            ...
            <body style="margin: 0; padding: 0; background-color: #f3dac6; font-family: Arial, Helvetica, sans-serif;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3dac6;">
                <tr>
                  <td style="padding: 40px 20px;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #3d0a10; border-radius: 18px; padding: 28px;">
                      <tr>
                      ...
                      <tr>
                        <td style="padding-bottom: 28px;">
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3dac6; border-radius: 12px; padding: 20px;">
                            <tr>
                              <td style="text-align: center;">
                                <div style="color: #3d0a10; font-size: 20px; font-weight: bold; margin-bottom: 8px;">10% off your first order</div>
                                <div style="color: #3d0a10; font-size: 16px;">Use code: <strong>FIRSTBATCH10</strong></div>
                              </td>
                            </tr>
                          </table>
                        </td>
                      ...
                      <tr>
                        <td style="text-align: center; padding-top: 20px; border-top: 1px solid rgba(243, 218, 198, 0.2);">
                          <p style="color: #f3dac6; font-size: 14px; margin: 0;">Sunday Oven</p>
                        </td>
                      </tr>
                    </table>
                  </td>
