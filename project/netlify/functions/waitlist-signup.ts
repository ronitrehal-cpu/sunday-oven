...
<style>
  ...
  @media screen and (max-width: 600px) {
    ...
    .h2-mobile { font-size: 20px !important; }
    .body-mobile { font-size: 15px !important; line-height: 1.65 !important; }
    .code-mobile { font-size: 26px !important; letter-spacing: 6px !important; }
  }
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" class="force-light" style="background-color:#f5ede1;">
  <tr>
    <td align="center" style="padding: 40px 16px;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="container" style="width:600px; max-width:600px; background-color:#3a0f10; border-radius:16px; overflow:hidden; box-shadow: 0 24px 60px rgba(58, 15, 16, 0.18);">
        <tr>
          <td style="height:4px; background: linear-gradient(90deg, #c9a96a 0%, #e6cb95 50%, #c9a96a 100%); line-height:4px; font-size:0;">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" class="px-mobile" style="padding: 48px 56px 8px 56px;">
            <img src="https://sundayoven.com.au/stackedwordmarkbeige.png"
                 alt="Sunday Oven"
                 width="200"
                 style="display:block; width:200px; max-width:200px; height:auto; border:0; outline:none; text-decoration:none;">
          </td>
        </tr>
        <tr>
          <td align="center" class="px-mobile" style="padding: 24px 56px 0 56px;">
            <h1 class="h1-mobile" style="margin:0; font-family:'Playfair Display', Georgia, serif; font-size:40px; font-weight:600; color:#f5ede1; line-height:1.1; letter-spacing:-0.5px;">
              You're on the list.
            </h1>
          </td>
        </tr>
        <tr>
          <td align="center" style="padding: 28px 56px 0 56px;">
        ...
        <tr>
          <td class="px-mobile" style="padding: 28px 56px 0 56px;">
        ...
        <tr>
          <td class="px-mobile" style="padding: 40px 56px 0 56px;">
        ...
        <tr>
          <td class="px-mobile" style="padding: 40px 56px 0 56px;">
            <h2 class="h2-mobile" style="margin:0 0 20px 0; font-family:'Playfair Display', Georgia, serif; font-size:22px; font-weight:500; color:#f5ede1; text-align:center; letter-spacing:-0.2px;">
              What happens next
            </h2>
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding: 40px 56px 0 56px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" style="background-color:#c9a96a; border-radius:50px;">
                  <a href="https://sundayoven.com.au" target="_blank" style="display:inline-block; padding:16px 36px; font-family:'Inter', Helvetica, Arial, sans-serif; font-size:14px; font-weight:600; color:#3a0f10; text-decoration:none; letter-spacing:1px; text-transform:uppercase;">
                    Visit Sunday Oven
                  </a>
                </td>
              </tr>
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding: 36px 56px 0 56px;">
        ...
        <tr>
          <td align="center" class="px-mobile" style="padding: 28px 56px 40px 56px;">
            <p style="margin:0 0 8px 0; font-family:'Inter', Helvetica, Arial, sans-serif; font-size:12px; line-height:1.6; color:#f5ede1; opacity:0.6;">
            ...
            <p style="margin:0 0 16px 0; font-family:'Inter', Helvetica, Arial, sans-serif; font-size:12px; line-height:1.6; color:#f5ede1; opacity:0.5;">
              Melbourne, Australia
            </p>
